...
const schedule = {
    'Day 1': [
        ...
        { name: 'Art', start: '10:30', end: '11:10' },
    ...
    'Day 2': [
        ...
        { name: 'Lunch/Recess', start: '11:10', end: '12:00' },
        { name: 'Office Hours', start: '12:00', end: '12:35' },
        { name: 'Art', start: '12:40', end: '13:25' },
    ...
    'Day 3': [
        ...
        { name: 'Art', start: '13:30', end: '14:15' },
    ...
    'Day 4': [
        ...
        { name: 'Art', start: '14:20', end: '15:00' }
    ],
    'Day 5': [
    ...
    'Day 6': [
        { name: 'Art', start: '08:10', end: '08:55' },
    ...
    'Day 7': [
        ...
        { name: 'Art', start: '09:00', end: '09:40' },
    ...
    'Day 8': [
        ...
        { name: 'Art', start: '09:45', end: '10:25' },
...
const holidays = [
    ...
    '2025-09-23',
    '2025-10-02',
    '2025-10-13', '2025-10-14', '2025-10-15', '2025-10-24',
    '2025-11-03',
    '2026-02-16', '2026-02-17', '2026-02-18',
    '2026-02-27', '2026-03-02', '2026-03-03', '2026-03-04', '2026-03-05', '2026-03-06',
    '2026-04-02', '2026-04-03', '2026-04-06', '2026-05-01', '2026-04-29',
];

// 4. SET THE LAST DAY OF SCHOOL
const lastDayOfSchool = new Date('2026-05-22');
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // Corrected logic: Count school days from the anchor date up to (and including) today
